...
@injectable()
class CreateProductionFunnelCardDefaultInfoFieldsService {
  constructor(
  ...
  public async execute({
    ...
    const firstProductionInfoFieldExists = await this.companyFunnelCardInfoFieldsRepository.findByFunnelIdAndName(
      funnel_id,
      'Cliente',
    );

    const secondProductionInfoFieldExists = await this.companyFunnelCardInfoFieldsRepository.findByFunnelIdAndName(
      funnel_id,
      'Tipo de Evento',
    );

    const thirdProductionInfoFieldExists = await this.companyFunnelCardInfoFieldsRepository.findByFunnelIdAndName(
      funnel_id,
      'Data do Evento',
    );

    const fourthProductionInfoFieldExists = await this.companyFunnelCardInfoFieldsRepository.findByFunnelIdAndName(
      funnel_id,
      'Valor Esperado',
    );

    const fifthProductionInfoFieldExists = await this.companyFunnelCardInfoFieldsRepository.findByFunnelIdAndName(
      funnel_id,
      'Probabilidade',
    );

    if (
      firstProductionInfoFieldExists ||
      secondProductionInfoFieldExists ||
      thirdProductionInfoFieldExists ||
      fourthProductionInfoFieldExists ||
      fifthProductionInfoFieldExists
    ) {
...
export default CreateProductionFunnelCardDefaultInfoFieldsService;
